...
(function () {
    this.onOpenFileFilter = function(event) {
    ...
    this.onDisableFileFilter = function(toolbarButton) {
        var attr;
    ...
    this.onOpenComparison = function(event) {
        var result = {isOk : false,
    ...
    this.onChangeDisplayFilter = function(filterValue) {
